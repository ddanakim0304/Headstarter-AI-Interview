        ...
        <>
          <div className="w-fit">
            <p className="text-xs text-gray-500 p-2">Voice:</p>
                ...
                className="flex-1 bg-gradient-to-r from-purple-300 to-blue-500 text-white border
                border-gray-300 text-sm rounded-lg focus:ring-purple-500
                focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700
                dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-purple-500
